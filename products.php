...
$stmt = $db->prepare('SELECT * FROM products ORDER BY date_added DESC LIMIT ?,?');
      ...
      <div class="container">
        ...
        <section class="py-5">
          <header>
            ...
            <h2 class="h5 text-uppercase mb-4">All Products</h2>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
              <div class="product text-center">
                <div class="position-relative mb-3">
                  <div class="badge text-white badge-"></div><a class="d-block" href="index.php?page=product&id=<?=$product['id']?>">
                    <img class="img-fluid w-100" style="width: 5rem; height: 15rem;" src="img/<?=$product['image']?>" alt="<?=$product['name']?>"></a>
