...
$stmt = $db->prepare('SELECT * FROM products WHERE categories_id=3 ORDER BY date_added DESC LIMIT ?,?');
...
$total_products = $db->query('SELECT * FROM products WHERE categories_id=3')->rowCount();
?>
      ...
      <div class="container">
        ...
        <section class="py-5">
          <header>
            ...
            <h2 class="h5 text-uppercase mb-4">Components</h2>
