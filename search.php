...
$stmt = $search_query = $_GET['user_query'];
$stmt = $db->prepare("SELECT * FROM products where prokey like '%$search_query%' or name like '%$search_query%'");
...
$total_products = $db->query("SELECT * FROM products where prokey like '%$search_query%' or name like '%$search_query%'")->rowCount();
?>
      ...
      <div class="container">
        ...
        <section class="py-5">
          <header>
            ...
            <h2 class="h5 text-uppercase mb-4">Searched items</h2>
